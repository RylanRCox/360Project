		...
		<div class="feedbox">
			<div class="feed">
				...
				<div class="post">
					<div class="post-head">
						<div class="votes">
							<button type="submit" id="postbreadvote"><img src="images/breadstick.png"
									class="breadStickImage" alt="UpBread"></button>
							<p id="voteCount"></p>
						</div> <!--Close Votes-->
					...
					<div id="postBox">
						<form method="post" name="newPost" enctype="multipart/form-data" onsubmit="return validate()"
							action="./PHP/addComment.php">
							<fieldset>
								<div id="contentContainer">
									<textarea id="contentText" name="content" rows="15" cols="102"
