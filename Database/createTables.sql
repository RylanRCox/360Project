...
CREATE TABLE notifications (
	...
	FOREIGN KEY (notificationUserID) REFERENCES users(userID) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (postID) REFERENCES posts(postID) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (commentParentID) REFERENCES comments(commentID) ON DELETE CASCADE ON UPDATE CASCADE
);

INSERT INTO users VALUES (-1,"deletedemail","NOONESHOULDEVERUSETHISEVER$!@*#!*!*#!)(*!&!@*9832519823498101283489!(@*#()*!@*$(!%*(&!@(*&!@#(*!@#*8932982140981239048!(*!@#*(!@&(*!@(*!@*","deleted",DEFAULT,DEFAULT,'[DELETED USER]',DEFAULT,DEFAULT);
INSERT INTO users VALUES (0,"adminEmail@admin.com","0cc175b9c0f1b6a831c399e269772661","TestAdmin",DEFAULT,DEFAULT,'Admin User',1,DEFAULT);	
...
INSERT INTO posts VALUES (DEFAULT,"Test Post 1", "", NULL, NULL, 20, DEFAULT, 1, -1 );
INSERT INTO posts VALUES (DEFAULT,"Test Post 2", "1", NULL, NULL, 13, DEFAULT, 2, -1 );
INSERT INTO posts VALUES (DEFAULT,"Test Post 3", "1", NULL, NULL, 93, DEFAULT, 3, -1 );
INSERT INTO posts VALUES (DEFAULT,"Test Post 4", "1", NULL, NULL, 21, DEFAULT, 2, -1 );
INSERT INTO posts VALUES (DEFAULT,"Test Post 5", "1", NULL, NULL, 30, DEFAULT, 3, -1 );
