        ...
        <form method="post" enctype='multipart/form-data' id="newPost" action="PHP/savePost.php">
            ...
            <fieldset>
                <div id="titleContainer">
                    <input type="text" id="title" name="title" placeholder="Enter your post's Title" class="textfield"
                        required />
                </div>
                ...
                <div id="newPostContentContainer">
                    <textarea id="content" name="content" rows="15" cols="102" placeholder="Enter your content here"
                        required></textarea>
                </div>
